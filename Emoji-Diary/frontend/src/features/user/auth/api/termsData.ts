 ...
 * ========================================
 * 
 * [플로우 1.3] 회원가입 플로우 - 약관 동의
 * 
 * 회원가입 시 동의해야 하는 약관 목록
 * - **필수 약관만 존재** (선택 약관 없음)
 * - 서비스 이용약관 (필수)
 * - 개인정보 처리방침 (필수)
 * 
 * [명세서 요구사항]
 * - 필수 약관만 존재
 * - 마케팅 정보 수신 동의 등 선택 약관 없음
 * - 전체 약관 동의/해제 기능
 * - 개별 약관 체크박스 클릭 가능
 * - 약관 제목 클릭 시 상세 내용 모달 표시
 */
 ...
 * 
 * [필수 약관만 포함]
 * 1. 서비스 이용약관 (required: true)
 * 2. 개인정보 처리방침 (required: true)
 * 
 * ⚠️ 선택 약관 없음 (마케팅 정보 수신 동의 등)
 */

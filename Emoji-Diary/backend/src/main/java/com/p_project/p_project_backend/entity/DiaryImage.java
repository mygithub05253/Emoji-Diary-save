...
@Setter
@Entity
@Table(name = "diary_images", indexes = {
        @Index(name = "idx_diary_images_diary_id", columnList = "diary_id")
}) // 테이블명 설정 - diary_images, 인덱스 설정
...
public class DiaryImage {
    ...
    // 이미지 URL (image_url)
    @Column(name = "image_url", nullable = false, length = 500) // null 불가
